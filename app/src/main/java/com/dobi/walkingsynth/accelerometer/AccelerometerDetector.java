...
public class AccelerometerDetector implements SensorEventListener {
    ...
    //private ArrayList<Accelerometer> arr = new ArrayList<>();
    private Accelerometer2 acc;
    private ArrayList<Accelerometer2> arr = new ArrayList<>();
    private int count = 0;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        //acc = new Accelerometer(mAccelResult[0], mAccelResult[1], count);
        acc = new Accelerometer2(x,y,z,count);
        arr.add(acc);

    }
//    public ArrayList<Accelerometer> getArr(){
//        return arr;
//    }
       public ArrayList<Accelerometer2> getArr(){
       return arr;
    }
